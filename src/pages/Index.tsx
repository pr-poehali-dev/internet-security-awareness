...
const Index = () => {
  ...
  const quizQuestions = [
    ...
    {
      question: 'Вы подключились к бесплатному Wi-Fi в кафе. Безопасно ли заходить в интернет-банк?',
      options: [
        'Да, если сайт начинается с https://',
        'Да, если Wi-Fi требует пароль',
        'Нет, публичные сети небезопасны для банковских операций',
        'Да, если использовать режим инкогнито'
      ],
      correct: 2
    },
    {
    ...
    {
      question: 'Вы скачали программу с незнакомого сайта. Что делать перед установкой?',
      options: [
        'Сразу установить',
        'Проверить антивирусом и почитать отзывы',
        'Установить, если файл небольшой',
        'Спросить у друзей в соцсети'
      ],
      correct: 1
    },
    {
      question: 'Как часто нужно обновлять операционную систему и программы?',
      options: [
        'Раз в год',
        'Только когда что-то сломается',
        'Регулярно, как только выходят обновления',
        'Обновления не нужны'
      ],
      correct: 2
    },
    {
      question: 'Вам пришло SMS с выигрышем приза. Просят перейти по ссылке. Ваши действия?',
      options: [
        'Перейти и забрать приз',
        'Удалить SMS, это мошенничество',
        'Переслать друзьям',
        'Перейти через VPN'
      ],
      correct: 1
    },
    {
      ...
      options: [
        'Вид спорта',
        'Поддельные сайты для кражи данных',
    ...
    },
    {
      ...
      options: [
        ...
        'Да, если компьютер защищен паролем',
        'Лучше использовать менеджер паролей',
        'Да, если браузер Google Chrome'
      ],
      correct: 2
    },
    {
      question: 'Что делать, если вы случайно перешли на подозрительный сайт?',
      options: [
        'Быстро закрыть вкладку и проверить систему антивирусом',
        'Продолжить работу',
        'Перезагрузить компьютер',
        'Ввести свои данные и уйти'
      ],
      correct: 0
    },
    {
      question: 'Какой способ оплаты безопаснее всего для онлайн-покупок?',
      options: [
        'Перевод на карту продавца',
        'Виртуальная карта с лимитом или защищенные платежные системы',
        'Отправка наличных почтой',
        'Криптовалюта незнакомому продавцу'
      ],
      correct: 1
    },
    {
      question: 'Вы получили письмо от "техподдержки" с просьбой подтвердить пароль. Что делать?',
      options: [
        'Отправить пароль',
        'Игнорировать, настоящая поддержка никогда не просит пароли',
        'Позвонить отправителю',
        'Создать новый пароль и отправить его'
      ],
      correct: 1
    },
    {
      question: 'Зачем нужно делать резервные копии данных?',
      options: [
        'Это не нужно',
        'Чтобы восстановить файлы при потере или атаке вирусов',
